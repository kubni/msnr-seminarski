...
\toprule
U kojoj meri sledeći aspekti otežavaju kurs? \\
\textit{(1 - Uopšte se ne slažem, 5 - U potpunosti se slažem)}  & 1 & 2 & 3 & 4 & 5 \\

\midrule
Nedostupnost kvalitetnog materijala &      0.00\% &      1.64\% &      6.56\% &     19.67\% &     \textbf{72.13\%} \\
Postojanje nenadoknadivih kolokvijuma &      1.64\% &     13.11\% &     18.03\% &     27.87\% &     \textbf{39.34\%} \\
Postojanje obaveznih predispitnih obaveza &     13.11\% &     \textbf{36.07\%} &     19.67\% &     18.03\% &     13.11\% \\
Obavezan rad u grupi &     21.31\% &     19.67\% &     \textbf{26.23\%} &     24.59\% &      8.20\% \\
Nedostatak interakcije predavača sa studentima &      4.92\% &      8.20\% &     13.11\% &     26.23\% &     \textbf{47.54\%} \\
Online nastava &     26.23\% &     13.11\% &     \textbf{31.15\%} &     22.95\% &      6.56\% \\
Nezainteresovanost za temu koja se obradjuje na kursu &      3.28\% &      6.56\% &     19.67\% &     34.43\% &     \textbf{36.07\%} \\
Postojanje usmene naspram pismene provere znanja &     13.11\% &     13.11\% &     18.03\% &     \textbf{31.15\%} &     24.59\% \\
Nepovezanost gradiva izmedju predavanja i vežbi &      3.28\% &      3.28\% &      8.20\% &     34.43\% &     \textbf{50.82\%} \\
Prezahtevno ocenjivanje &      4.35\% &      8.70\% &      4.35\% &     34.78\% &     \textbf{47.83\%} \\
\bottomrule
\end{tabular}
}
\end{center}
